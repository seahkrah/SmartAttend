...
-- ===========================
-- K. HELPER FUNCTIONS (MUST BE DEFINED BEFORE TRIGGERS)
-- ===========================
...
DROP TRIGGER IF EXISTS prevent_audit_log_modification ON superadmin_audit_log;
...
DROP TRIGGER IF EXISTS prevent_tenant_lifecycle_modification ON tenant_lifecycle_audit;
